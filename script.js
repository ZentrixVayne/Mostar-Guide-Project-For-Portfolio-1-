document.addEventListener("DOMContentLoaded", () => {
  ...
  function onAssetLoad() {
    ...
    preloaderText.textContent = `MOSTAR ${progress}%`;
  ...
  function startExperience() {
    ...
    function update(time) {
      ...
      // Since Lenis is smoothing the native scroll, we can snap our internal smoothScroll to target
      ...
      // Re-evaluate hover targets after slider loads
